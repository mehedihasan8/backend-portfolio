const userData = {
  ...
  socialLinks: {
    linkedin: 'https://linkedin.com/in/jahidmorol',
    github: 'https://github.com/jahidmorol',
    facebook: 'https://facebook.com/jahidmorol2',
  },
  contact: {
    phone: '+8801873817685',
